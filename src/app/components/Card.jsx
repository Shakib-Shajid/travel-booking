                    ...
                    <div className="flex flex-col md:flex-row flex-wrap gap-4 justify-center w-[90%] mx-auto">
                        <div className="card bg-gradient-to-br from-blue-300 to-green-300 w-80 mx-auto">
                            <div className="card-body">
                                <h2 className="card-title text-xl font-extrabold text-gray-800">Precios más bajos exclusivos para clientes de Smart Tour</h2>
                        ...
                        <div className="card bg-gradient-to-br from-blue-300 to-green-300 w-80 mx-auto">
                            <div className="card-body">
                                <h2 className="card-title text-xl font-extrabold text-gray-800">Tarifa Smart Tour para todos</h2>
                        ...
                        <div className="card bg-gradient-to-br from-blue-300 to-green-300 w-80 mx-auto">
                            <div className="card-body">
                                <h2 className="card-title text-xl font-extrabold text-gray-800">Asistencia personalizada </h2>
