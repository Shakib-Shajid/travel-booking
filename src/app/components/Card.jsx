            ...
            <div className="max-w-7xl mx-auto" id="card" data-aos="fade-up">
                <div className="my-5 lg:my-20">
                    ...
                    <div className="flex flex-col md:flex-row flex-wrap gap-4 justify-center w-[90%] mx-auto">
                        <div className="card bg-gradient-to-br from-blue-300 to-green-300 w-72 md:w-80 mx-auto">
                            <div className="card-body">
                                <h2 className="card-title text-xl font-extrabold text-gray-800 font-roboto gradient-text4 ">Precios más bajos exclusivos para clientes de Smart Tour</h2>
                        ...
                        <div className="card bg-gradient-to-br from-blue-300 to-green-300 w-72 md:w-80 mx-auto">
                            <div className="card-body">
                                <h2 className="card-title text-xl font-extrabold text-gray-800 font-roboto gradient-text4 ">Tarifa Smart Tour para todos</h2>
                        ...
                        <div className="card bg-gradient-to-br from-blue-300 to-green-300 w-72 md:w-80 mx-auto">
                            <div className="card-body">
                                <h2 className="card-title text-xl font-extrabold text-gray-800 font-roboto gradient-text4 ">Asistencia personalizada </h2>
