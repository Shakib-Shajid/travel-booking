            ...
            <div className="max-w-7xl mx-auto" id="card">
                <div className="ml-4 md:ml-0 my-5 lg:my-20">
                    ...
                    <div className="flex flex-col md:flex-row flex-wrap gap-4 justify-center w-[90%] mx-auto">
                        <div className="card bg-gradient-to-br from-blue-300 to-green-300 w-80 mx-auto">
                            <div className="card-body">
                                <h2 className="card-title text-xl font-extrabold text-gray-800">Precios más bajos exclusivos para clientes Smart.</h2>
                        ...
                        <div className="card bg-gradient-to-br from-blue-300 to-green-300 w-80 mx-auto">
                            <div className="card-body">
                                <h2 className="card-title text-xl font-extrabold text-gray-800">Tarifa Smart para ti y tus acompañantes.</h2>
                        ...
                        <div className="card bg-gradient-to-br from-blue-300 to-green-300 w-80 mx-auto">
                            <div className="card-body">
                                <h2 className="card-title text-xl font-extrabold text-gray-800">Comparte los beneficios Smart.</h2>
